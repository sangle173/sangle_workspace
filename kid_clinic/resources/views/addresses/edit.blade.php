...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <h4 class="text-center mb-4"><i class="fa-solid fa-location-dot me-2"></i> {{ __('messages.edit_address') }}</h4>
                <form action="{{ route('addresses.update', $address) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $address->name) }}">
                            @error('name')
