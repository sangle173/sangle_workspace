    ...
    let content = `
      <div style="${styles.container}">
        ...
        <div style="margin-bottom: 20pt; text-align: left;">
          <h2 style="${styles.h2}">Task Breakdown</h2>
          
          <table style="${styles.table}">
            <tr>
              <th style="${styles.th}" colspan="2">By Task Type</th>
            </tr>
            ${Object.entries(summary.byType)
              .sort((a, b) => b[1] - a[1])
              .map(([type, count]) => 
                `<tr>
                  ...
                  <td style="${styles.td}">${count} (${Math.round(count / summary.totalTasks * 100)}%)</td>
                </tr>`
              ).join('')
            }
          </table>
          ...
          <table style="${styles.table}">
            <tr>
              <th style="${styles.th}" colspan="2">By Status</th>
            </tr>
    ...
    Object.entries(tasksByTeam).forEach(([team, teamData]) => {
      ...
      typeOrder.forEach(orderedType => {
        if (teamData.byType[orderedType]) {
          ...
          // For "Bugs Reported" type, skip working status sections
